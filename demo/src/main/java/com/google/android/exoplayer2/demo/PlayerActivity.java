...
import com.google.android.exoplayer2.demo.com.jango.CustomDrmCallback;
...
public class PlayerActivity extends Activity implements OnClickListener, ExoPlayer.EventListener,
    ...
    public static final String ACTION_VIEW_OFFLINE =
            "com.google.android.exoplayer.demo.action.VIEW.OFFLINE";
    ...
    public static final String EXTRA_OFFLINE_URI = "extra_offline_uri";
    ...
    private void initializePlayer() {
        ...
        if (player == null) {
            ...
            if (drmSchemeUuid != null) {
                ...
                try {
                    boolean isOffline = intent.getBooleanExtra(EXTRA_IS_OFFLINE, false);
                    if (isOffline) {
                        drmSessionManager = buildOfflineDrmSessionManager(drmSchemeUuid, drmLicenseUrl,
        ...
        if (playerNeedsSource) {
            ...
            } else if (ACTION_VIEW_OFFLINE.equals(action)) {
                String path = intent.getStringExtra(EXTRA_OFFLINE_URI);
                Uri uri = Uri.fromFile(getUriForManifest(path));
                uris = new Uri[]{uri};
                extensions = new String[]{intent.getStringExtra(EXTENSION_EXTRA)};
            } else {
