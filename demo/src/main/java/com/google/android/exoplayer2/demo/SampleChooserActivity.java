...
//            uriList.add("asset:///" + asset);
  ...
  private static final class OfflineSample extends Sample{

    public final String downloadUri;
    public final String uri;

    public OfflineSample(String name, UUID drmSchemeUuid, String drmLicenseUrl,
                         String[] drmKeyRequestProperties, boolean preferExtensionDecoders,
                         String uri, String downloadUri) {
    ...
    public Intent buildIntent(Context context) {
      return super.buildIntent(context)
              .putExtra(PlayerActivity.EXTRA_OFFLINE_URI,uri)
              .putExtra(PlayerActivity.EXTRA_IS_OFFLINE,true)
              .setAction(PlayerActivity.ACTION_VIEW_OFFLINE);
    }
  }
